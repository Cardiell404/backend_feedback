...
@Component({
    selector       : 'dashboard-board-new-reflection',
    templateUrl    : './new-reflection.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NewReflectionComponent implements OnInit {

    user: IUser;
    reflection: Reflection;
    reflectionForm: UntypedFormGroup;
    private _unsubscribeAll: Subject<any> = new Subject<any>();

    constructor( public matDialogRef: MatDialogRef<NewReflectionComponent>,
    ...
    ngOnInit(): void {
        ...
        this.reflectionForm = this._formBuilder.group({
        ...
        Cheers!
        Myra Dudley`
        this.reflectionForm.valueChanges.pipe(tap((value) => {
                this.reflection = assign(this.reflection, value);
     ...
     */
    isOverdue(): boolean {
        return DateTime.fromISO(this.reflection.createDate).startOf('day') < DateTime.now().startOf('day');
    }
    ...
    createReflection(): void {
        const data: Reflection = {...this.reflectionForm.getRawValue()};
        this.reflectionForm.disable();
        this._reflectionService.createReflection(data).subscribe((_) => {
          this.matDialogRef.close();
        }, (_) => {
          this.reflectionForm.enable();
        });
      }
}
