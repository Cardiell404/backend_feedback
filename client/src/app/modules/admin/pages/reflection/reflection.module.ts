import { NewReflectionComponent } from './board/new-reflection/new-reflection.component';
...
import { dashboardRoutes } from './reflection.routing';
import { InfiniteScrollModule } from 'ngx-infinite-scroll';

@NgModule({
    declarations: [
        ReflectionComponent,
        ReflectionBoardComponent,
