export const boards = [ {
        id        : 'feedback',
        title     : 'Feedback',
        subtitle  : 'Give, request and share',
        actionName: 'Feedback request',
        color     : 'blue',
    ...
    },
    {
        id        : 'conversations',
        title     : 'Conversations',
        subtitle  : 'Capture meaningful discussions',
...
export const cards = [
    {
        title      : 'Feedback',
        description: 'Give or ask for advice from colleagues',
    ...
    {
        title      : 'Conversations',
        description: 'Document individual or team conversations',
    ...
    {
        title      : 'Goals',
        description: 'Set a goal or a quick to-do',
    ...
    {
        title      : 'Reflections',
        description: 'Capture your progress and plan your growth',
